...
const AI_PROVIDERS = [
  { id: 'openai', name: 'OpenAI', desc: 'GPT-4o, GPT-4o-mini, o1', color: '#10a37f' },
  { id: 'gemini', name: 'Google Gemini', desc: 'Gemini 2.0 Flash, Pro', color: '#4285f4' },
  { id: 'groq', name: 'Groq', desc: 'LLaMA, Mixtral, Gemma', color: '#f55036' },
  { id: 'custom', name: 'Custom / Local', desc: 'Any OpenAI-compatible API', color: '#f59e0b' },
];
